return {
	...
	opts = function(_, opts)
		...
		config.defaults.keymap.builtin["tab"] = nil
		config.defaults.keymap.fzf["tab"] = nil
		config.defaults.keymap.fzf["tab"] = "down"
		config.defaults.keymap.fzf["shift-tab"] = "up"
		-- config.defaults.keymap.fzf["<Tab>"] = "ctrl-j"
		-- config.defaults.keymap.fzf["<S-Tab>"] = "ctrl-k"
	...
	keys = {
		{ "<Tab>", "<c-j>", ft = "fzf", mode = "t", nowait = true },
		{ "<S-Tab>", "<c-k>", ft = "fzf", mode = "t", nowait = true },
		{
			"<leader>,",
